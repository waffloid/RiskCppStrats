#ifndef CRISKY_STATIC_DEFENDER_AI_HPP
#define CRISKY_STATIC_DEFENDER_AI_HPP

#include "player/player_interface.hpp"
#include "engine/game.hpp"

// AI that never attacks but builds forts on owned nodes when affordable.
class StaticDefenderAI : public PlayerInterface {
public:
